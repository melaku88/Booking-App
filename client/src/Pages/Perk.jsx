...
function Perks({perks, setPerks}) {
  ...
  return (
    <>
      <label className='border border-gray-300 p-4 rounded-2xl flex gap-2 items-center cursor-pointer'>
      ...
      <label className='border border-gray-300 p-4 rounded-2xl flex gap-2 items-center cursor-pointer'>
        <input type="checkbox"checked = {perks.includes('radio')} name='radio' onChange={handleCbClick} />
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
      ...
      <label className='border border-gray-300 p-4 rounded-2xl flex gap-2 items-center cursor-pointer'>
        <input type="checkbox"checked = {perks.includes('entrance')} name='entrance' onChange={handleCbClick} />
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
